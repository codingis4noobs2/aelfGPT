...
st.subheader("Analyze and Enhance Your Aelf Smart Contracts")
    ...
    if st.button("Submit Debug Request"):
        if cs_code:
            ...
            with st.spinner("Debugging code..."):
                # Prompt the LLM to debug the .cs code
                debug_prompt = f"Debug the following Aelf smart contract .cs code and provide insights on potential issues:\n\n{cs_code}"
    ...
    if st.button("Submit Generate Request"):
        if cs_code:
            ...
            with st.spinner("Generating code..."):
                ...
                generate_prompt = f"Generate code for the following Aelf smart contract .cs code and provide improvements or enhancements:\n\n{cs_code}"
